  ...
  return (
    <div className={classNames(className, 'flex items-center justify-center gap-2')}>
      <button className="p-1" onClick={handleZoomOut}>
        <MinusIcon className="text-black-400 w-4" />
      </button>
      <input
        type="range"
        name="volju"
      ...
      <button className="p-1" onClick={handleZoomIn}>
        <PlusIcon className="text-black-400 w-4" />
      </button>
    </div>
  );
};
  ...
  return (
    <div className={classNames(className, 'flex items-center justify-center gap-2')}>
      <button className="p-1" onClick={handleRotateAntiCw}>
        <ArrowUturnLeftIcon className="text-black-400 w-4" />
      </button>
      <input
        type="range"
        name="volju"
      ...
      <button className="p-1" onClick={handleRotateCw}>
        <ArrowUturnRightIcon className="text-black-400 w-4" />
      </button>
    </div>
  );
};
